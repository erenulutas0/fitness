...
void main() {
  ...
  final fixtures = <LandmarkFixture>[
    ...
    LandmarkFixture(
      ...
      synthetic: true,
      expectedReps: 3,
      errorLabels: allReps(3, ['hip_pike']),
      frames: syn.pushUp(reps: 3, hipSag: -0.09),
      notes: 'hips above the shoulder-ankle line',
    ),
    LandmarkFixture(
      id: 'syn_pushup_shallow',
      exerciseId: 'push_up',
      view: CameraView.side,
      synthetic: true,
      expectedReps: 3,
      errorLabels: allReps(3, ['shallow_depth']),
      frames: syn.pushUp(reps: 3, peakAngle: 112),
      notes: 'elbows never pass 100 degrees',
    ),
    LandmarkFixture(
      id: 'syn_squat_front_shallow',
      exerciseId: 'bw_squat',
      view: CameraView.front,
      synthetic: true,
      expectedReps: 4,
      errorLabels: allReps(4, ['shallow_depth_front']),
      frames: syn.squat(view: CameraView.front, reps: 4, peakAngle: 118),
      notes: 'the front-view depth rule, which uses the 3D knee angle',
    ),
    LandmarkFixture(
      id: 'syn_plank_pike',
      exerciseId: 'plank',
      ...
      errorLabels: const [
        FixtureLabel(rep: 1, rules: ['hip_pike']),
      ],
      frames: syn.plank(durationMs: 15000, hipSag: -0.09),
    ),
    LandmarkFixture(
      id: 'syn_plank_head_drop',
      exerciseId: 'plank',
      view: CameraView.side,
      synthetic: true,
      expectedHoldMs: 15000,
      errorLabels: const [
        FixtureLabel(rep: 1, rules: ['head_drop']),
      ],
      frames: syn.plank(durationMs: 15000, headDropDeg: 40),
    ),
    LandmarkFixture(
      id: 'syn_plank_clean',
      exerciseId: 'plank',
